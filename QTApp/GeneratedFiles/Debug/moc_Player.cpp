...
QT_MOC_LITERAL(3, 21, 4) // "iKey"

    },
    "Player\0onKeyPressed\0\0iKey"
};
...
void Player::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onKeyPressed((*reinterpret_cast< const char(*)>(_a[1]))); break;
        default: ;
        }
        ...
        {
            typedef void (Player::*_t)(const char );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Player::onKeyPressed)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void Player::onKeyPressed(const char _t1)
{
